...
function custom_translate_cart_strings($translated_text, $text, $domain)
{
	$translations = array(
		'Related Products' => 'Sản phẩm liên quan',
		'Categories:' => 'Danh mục',
		'Remove item' => 'Xoá sản phẩm',
		// Thêm các chuỗi khác như "Proceed to Checkout", "Update Cart", v.v.
	);
...
add_filter('gettext', 'custom_translate_cart_strings', 20, 3);
